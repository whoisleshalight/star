(() => {
    ...
    function timer() {
        ...
        var achiveDate = new Date(2022, 5, 28, 0, 2, 0);
    ...
    if (animItems.length > 0) {
        ...
        function animOnScroll() {
            for (let index = 0; index < animItems.length; index++) {
                ...
                if (pageYOffset > animItemOffset - animItemPoint && pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("_animact"); else if (!animItem.classList.contains("_anim-no-hide")) animItem.classList.remove("_animact");
            }
        }
        function offset(el) {
